...
public class RoomManager : MonoBehaviourPunCallbacks
{
    ...
    public override void OnRoomListUpdate(List<RoomInfo> roomList)
    {
        ...
        {
            Debug.Log(room.Name);
            if (room.Name.Contains(MultiplayerVRConstant.MAP_TYPE_VALUE_OUTDOOR))
            {
            ...
            else if (room.Name.Contains(MultiplayerVRConstant.MAP_TYPE_VALUE_SCHOOL))
            {
    ...
    {
        string randomroomRoomName = "Room_" + mapType + Random.Range(0, 10000);
        ...
        PhotonNetwork.CreateRoom(randomroomRoomName,roomOptions);
    }
    #endregion
}
